...
nstacks = 8;                                          %Stacking parameter
r = 160;                                              %SVD: rank truncation 
...
Xs = 0.9.*sin(-(2.*t-1.8).^2);
Xss = -0.9.*exp(-(20.*t-2.8).^2);
Xi = repmat(Xs, N/2, 1);
...
%We temporalily remove normalization by commenting this section
X_0 = X_zero ;
Xcol = X_0(:);
